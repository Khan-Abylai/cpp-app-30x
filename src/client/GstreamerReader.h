...
public:
    ...
    const std::string &getZmqServer() const;

    void setSensorCameraTrigger(std::shared_ptr<SensorCameraTrigger> sensorTrigger);
...
private:
    ...
    std::shared_ptr<SensorCameraTrigger> sensorCameraTrigger;
